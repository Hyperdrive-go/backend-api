"""
Django settings for hyperdrive_backend project.
...
ROOT_URLCONF = "hyperdrive_backend.urls"
...
WSGI_APPLICATION = "hyperdrive_backend.wsgi.application"
...
# ):
#     DATABASE_ROUTERS = ["hyperdrive_backend.router.PrimaryReplicaRouter"]
